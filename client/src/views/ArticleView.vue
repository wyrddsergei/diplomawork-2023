    ...
    <div class="article-content-container">
      <div class="article-content">
        <div class="article-text-wrapper">
          ...
          <div class="article-date">Posted on {{ formatTimestamp(article.createdAt) }}</div>
        </div>
        <div class="article-author">
          ...
          <div id="author-links">
            <a class="a-link" href="https://twitter.com">
            ...
            <a class="a-link" href="https://instagram.com">
            ...
            <a class="a-link" href="https://web.telegram.org">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                <path
...
export default {
  data() {
    return {
      article: '',
      comments: [] // Your array of comments
    }
  },
  mounted() {
    this.fetchPost()
  ...
  methods: {
    ...
    fetchComments() {
      this.axios
        .get(`http://localhost:4000/api/comments/${this.$route.params.id}`)
        .then((response) => {
    ...
    fetchUserInformation() {
      ...
      const userIds = [...new Set(this.comments.map((comment) => comment.authorId))]
      ...
      userIds.forEach((userId) => {
        this.axios
          ...
          .then((response) => {
            ...
            // Update the comment object with user information or dummy data
          ...
          .catch((error) => {
            ...
            // Update the comment object with dummy data for failed requests
            this.comments.forEach((comment) => {
              if (comment.authorId === userId) {
                comment.user = {
                  username: 'Deleted User',
